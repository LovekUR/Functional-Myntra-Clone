...
function displayBagSummary(){
  ...
  bagItemsObjects.forEach(bagItems =>{
    ...
    toatlDiscount += bagItems.original_price - bagItems.current_price;
  });

  let totalPayment = totalMRP - toatlDiscount +CONVENIENCE_FEES;
  ...
  bagSummaryElement.innerHTML = `<div class="bag-details-container">
            ...
            <div class="price-item">
              ...
              <span class="price-item-value priceDetail-base-discount">-₹${toatlDiscount}</span>
            </div>
            <div class="price-item">
